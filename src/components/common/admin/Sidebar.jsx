  ...
  return (
    <div className={`h-screen ${isCollapsed ? "w-20" : "w-64"} bg-gray-900 text-white flex flex-col p-4 transition-all duration-300`}>
      ...
      <nav className="flex-1 space-y-2">
        ...
        <Link to="/admin/wishlist" className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-700 transition-colors duration-200">
          <Heart size={20} />
          {!isCollapsed && <span>Wishlist</span>}
        </Link>

        <Link to="/admin/reviews" className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-700 transition-colors duration-200">
          <Star size={20} />
